...
class Booking extends Component {
  ...
  Canceled = id => {
    return fetch('https://quangdev12.000webhostapp.com/api/api_cancel/' + id, {
      method: 'get',
    })
            ...
            [
              {
                text: 'Thành công',
                onPress: () =>
                  this.props.dispatch({type: 'UPDATE_HOTEL_LIST', payload: 1}),
              },
            ],
            {cancelable: false},
          );
  ...
  Booking_All = () => {
    return fetch(
      'https://quangdev12.000webhostapp.com/api/api_view_booking_waiting',
      {
        method: 'post',
        headers: {
  ...
  componentDidUpdate(prevProps) {
    if (prevProps.updateHotelList !== this.props.updateHotelList) {
      ...
      this.setState({ loading: true}, this.Booking_All);
                    ...
                    <View style={{flexDirection: 'row'}}>
                      ...
                      <View style={{width: '40%'}}>
                        <Button
                          ...
                          onPress={() => this.Canceled(item.id_bill)}
                          color="#ff4000"
                          title="Cancel"
                        />
                      </View>
...
const mapStateToProps = state => ({
  updateHotelList: state.users.updateHotelList,
});
